...
const services = [
  ...
  {
    icon: Video,
    title: "AI Content Creation & Auto-Posting",
    description:
      "Your social media on autopilot. AI creates engaging posts and videos, then publishes automatically while you focus on business.",
    features: [
      { icon: Share2, text: "Multi-platform posting" },
      { icon: Play, text: "AI video creation" },
      { icon: FileText, text: "Blog writing" },
